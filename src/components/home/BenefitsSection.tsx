...
export const BenefitsSection = () => {
  return (
    <section className="py-24 bg-background relative overflow-hidden">
      {/* Ambient effects */}
      <div className="absolute top-0 left-1/4 w-96 h-96 bg-copper/3 rounded-full blur-[150px]" />
      <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-petrol/3 rounded-full blur-[150px]" />
              ...
              <GlowCard className="h-full overflow-hidden group">
                <div className="h-full">
                  <div className="relative h-52 overflow-hidden">
                    ...
                    {/* Icon overlay */}
                    <motion.div 
                      className={`absolute top-4 right-4 w-12 h-12 rounded-xl bg-gradient-to-br ${benefit.color} backdrop-blur-sm flex items-center justify-center border border-white/10`}
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-display text-foreground mb-3 group-hover:text-copper transition-colors duration-300">
                      {benefit.title}
                    </h3>
