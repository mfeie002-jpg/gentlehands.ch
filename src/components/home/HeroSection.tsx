        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <AnimatePresence mode="wait">
            <motion.div key={activeVariant.id}>
              <h1 className="text-foreground text-[1.75rem] leading-tight sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-display">
                ...
                <span className="block overflow-hidden mb-4 sm:mb-6">
                  <motion.span
                    className="block"
                    initial={{ y: 80, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
