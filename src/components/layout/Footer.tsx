...
export const Footer = () => {
  return (
    <footer id="footer" className="relative bg-gradient-to-b from-secondary/30 to-secondary/60 border-t border-border overflow-hidden" role="contentinfo" aria-label="Fußzeile">
      {/* Decorative Elements */}
